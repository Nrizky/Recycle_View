...
public class FootballAdapter extends RecyclerView.Adapter<FootballAdapter.ViewHolder> {
    ...
    public FootballAdapter(Context context, ArrayList<FootballModel> footballModels) {
        this.context = context;
    ...
    public FootballAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemRow = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_footbal,viewGroup,false);
